...
return {
	descriptions = {
		...
		Blind = {
			...
			bl_cry_decision = {
				...
				text = {
					...
					"Проклятого Джокера из «Злобного",
					"набора шута» после раунда.",
				},
			},
			bl_cry_repulsor = {
				name = "Репульсор",
		...
		Joker = {
			...
			j_cry_monopoly_money = {
				...
				text = {
					...
					"При продаже забирает все деньги",
				},
			},
		...
		Sleeve = {
			...
			sleeve_cry_antimatter_sleeve = {
				...
				text = {
					"Применяет {C:legendary,E:1}плюсы{}",
					"каждого {C:attention}эффекта{} и {C:attention}особого эффекта{}",
					"{C:attention}всех выбранных рукавов{}",
				},
			},
			sleeve_cry_antimatter_sleeve_balanced = {
				name = "Рукав антиматерии",
				text = {
					"Применяет {C:legendary,E:1}плюсы{} {C:attention}эффектов{}",
					"{C:attention}всех выбранных рукавов{}, пройденных на {C:gold}Золотой ставке{},",
					"и {C:attention}особые эффекты{} для каждой соответствующей",
					"{C:attention}колоды{}, пройденной на {C:gold}Золотой ставке{}",
				},
			},
		},
	...
	misc = {
		...
		dictionary = {
			...
			cry_gameset_ongoing_warning = "(Параметры набора игры нельзя переключать во время текущей игры)",
