	...
	descriptions = {
		...
		Sleeve = {
			...
			sleeve_cry_antimatter_sleeve = {
				name = "反物質スリーブ",
				text = {
					"{C:attention}選択したすべてのスリーブ{}の",
					"各{C:attention}効果{}および{C:attention}特殊効果{}の",
					"{C:legendary,E:1}メリット効果{}を適用する",
				},
			},
			sleeve_cry_antimatter_sleeve_balanced = {
				name = "反物質スリーブ",
				text = {
					"{C:gold}ゴールドステーク{}で勝利済みの",
					"{C:attention}選択したスリーブ{}の{C:attention}効果{}と、",
					"{C:gold}ゴールドステーク{}で勝利済みの対応する",
					"{C:attention}デッキ{}の{C:attention}特殊効果{}の",
					"{C:legendary,E:1}メリット効果{}を適用する",
				},
			},
		},
